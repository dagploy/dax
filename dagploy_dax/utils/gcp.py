...
def get_hf_or_gcp_disk_image(model_repo: str, branch: str = ""):
    """
    Check if input  if model_repo is a Hugging Face repo or a local image name, and return the normalized image name and a boolean indicating if it's local.
    """
    is_snapshot = False
